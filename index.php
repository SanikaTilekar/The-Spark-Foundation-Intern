...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #82E0AA;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="https://m.economictimes.com/thumb/msid-69356756,width-1200,height-900,resizemode-4,imgsize-123119/bank-agencies.jpg" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SANIKA TILEKAR</b> <br> sanika tilekars foundation</p>
      </footer>
